...
return [
    ...
    */
    ...
    'schema' => [
        'public' => base_path('graphql/public.graphql'),
        'superAdmin' => base_path('graphql/superAdmin.graphql'),
        'admin' => base_path('graphql/admin.graphql'),
        'client' => base_path('graphql/client.graphql'),
    ],
